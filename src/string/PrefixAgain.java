...
public class PrefixAgain {
    ...
    public static void main(String[] args) {
        ...
        boolean result = rest.contains(prefix);
...
use the given `n` value. For example, if `n` is 2, the prefix is the first two characters,
so you would check if the String from the 3rd character until the end has those two character repeating anywhere.
